...
class RegistrationController extends AbstractController
{
    ...
    public function __construct(private EmailVerifier $emailVerif)
    {
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, Security $security,
                             EntityManagerInterface $entityManager, AppAuthenticator $appAuthenticator,
                             UserAuthenticatorInterface $userAuthenticator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //    (new TemplatedEmail())
            //        ->from(new Address('support@foodbox.fr', 'Support'))
